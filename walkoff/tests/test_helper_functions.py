...
from walkoff.tests.config import test_workflows_path, test_apps_path
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_import_py_file(self):
        module_name = 'walkoff.tests.testapps.HelloWorld'
    ...
    def test_import_app_main(self):
        module_name = 'walkoff.tests.testapps.HelloWorld.main'
    ...
    def test_import_submodules(self):
        from walkoff.tests import testpkg
        base_name = 'walkoff.tests.testpkg'
