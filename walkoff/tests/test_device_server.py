...
class TestDevicesServer(ServerTestCase):
    ...
    def test_export_apps_devices_no_filename(self):
        ...
        self.assertIn('appdevice.json', os.listdir(walkoff.tests.config.test_data_path))
    ...
    def test_export_apps_devices_with_filename(self):
        ...
        filepath = os.path.join(walkoff.tests.config.test_data_path, filename)
        ...
        self.assertIn(filename, os.listdir(walkoff.tests.config.test_data_path))
